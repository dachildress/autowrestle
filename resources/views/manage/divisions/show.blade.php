...
@else
    <table class="table-dark">
        <thead>
            <tr>
                <th>Name</th>
                <th style="text-align: center;">Boys / Girls</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $group->Name }}</td>
                <td style="text-align: center;">{{ $group->gender === 'coed' ? 'Co-ed' : ucfirst($group->gender ?? 'boys') }}</td>
                <td style="text-align: center;">{{ $group->MinAge }}</td>
                <td style="text-align: center;">{{ $group->MaxAge }}</td>
                <td style="text-align: center;">{{ $group->display_min_grade }}</td>
                <td style="text-align: center;">{{ $group->display_max_grade }}</td>
